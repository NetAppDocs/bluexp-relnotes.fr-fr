...
* https://docs.netapp.com/us-en/cloud-manager-backup-restore/whats-new.html["Sauvegarde et restauration"^]
* https://docs.netapp.com/us-en/cloud-manager-data-sense/whats-new.html["Classement"^]
* https://docs.netapp.com/us-en/cloud-manager-compute/whats-new.html["OPS cloud"^]
* https://docs.netapp.com/us-en/cloud-manager-sync/whats-new.html["Copie et synchronisation"^]
...
* https://docs.netapp.com/us-en/cloud-manager-file-cache/whats-new.html["La mise en cache en périphérie"^]
* https://docs.netapp.com/us-en/bluexp-operational-resiliency/index.html["Résilience opérationnelle"^]
* https://docs.netapp.com/us-en/cloud-manager-ransomware/whats-new.html["Protection par ransomware"^]
* https://docs.netapp.com/us-en/cloud-manager-app-template/whats-new.html["Résolution"^]
